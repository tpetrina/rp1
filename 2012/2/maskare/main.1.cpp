...
int main(void)
{
    maskare mask;
     ...
     mask.dodaj("josip", -2); mask.dodaj("bosko", 3); mask.dodaj("alma", 7);
     mask.dodaj("ivana", 1); mask.dodaj("marko", 2); mask.dodaj("igor", -1);
     mask.dodaj("mate", 3); mask.dodaj("filip", 5); mask.dodaj("ante", 5);
     mask.dodaj("petar", -1); mask.dodaj("karlo",1); mask.dodaj("maja", -10);
     mask.dodaj("tonci", 2); mask.dodaj("kristina", -1); mask.dodaj("ana", -4);
     mask.izbrisi("mate"); mask.izbrisi("tonci");
