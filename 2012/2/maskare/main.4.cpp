...
int main(void)
{
    ...
    mask.dodaj("ivana", 1); mask.dodaj("marko", 3); mask.dodaj("igor", -7);
    mask.dodaj("mate", 1); mask.dodaj("filip", 5); mask.dodaj("ante", -15);
    mask.dodaj("petar", 1); mask.dodaj("karlo",1); mask.dodaj("maja", 5);
