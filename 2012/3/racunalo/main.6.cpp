...
int main(void)
{
    ...
    delete nizRacunala[5];
    racunalo &najbrze1 = racunalo::najbrzeRacunalo();
    cout << najbrze1.brzina() << " " << najbrze1.ram() << " " << najbrze1.velicinaEkrana() << endl;

    delete nizRacunala[1];
    racunalo &najbrze2 = racunalo::najbrzeRacunalo();
    cout << najbrze2.brzina() << " " << najbrze2.ram() << " " << najbrze2.velicinaEkrana() << endl;
