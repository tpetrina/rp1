...
int main(void)
{
    ...
    for(int i = 0; i < 8; i++)
        cout << nizVozila[i]->snagaMotora() << " " << nizVozila[i]->brojKotaca() << " " << nizVozila[i]->registracija() << endl;

    cout << M.snagaMotora() << " " << M.brojKotaca() << " " << M.registracija() << endl;
    cout << T.snagaMotora() << " " << T.brojKotaca() << " " << T.registracija() << " " <<T.brojVrata() << endl;
