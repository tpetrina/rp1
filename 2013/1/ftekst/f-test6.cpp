...
int main(int argc, const char *argv[])
{
    ...
    string s2 =
        ...
        "ovo je ludnica.  ili?\n"
        "\n"
        "The parameters index and num have default values, which means that erase() can be called with just index to erase all characters after index or with no arguments to erase all characters.  Druga\n"
        "recenica.  Treca recenica.\n";


    FTekst FT = FTekst(s1);

    if( FT.rijeciVanLinije(200) == string("hehe;jedna;prica;recenica;recenica;Treca")){
        cout << "Ispravno!" << endl;
    }
    else{
